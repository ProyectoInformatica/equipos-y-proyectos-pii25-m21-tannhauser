...
class AdminEliminarUsuarioView(ft.View):
    def __init__(self, page: ft.Page, go):
        ...
        self.btn_buscar = ft.Button("Buscar", icon=ft.Icons.SEARCH, on_click=self.buscar_usuario)
        self.btn_eliminar = ft.Button("Eliminar Usuario", icon=ft.Icons.DELETE, bgcolor=ft.Colors.RED_700, on_click=self.confirmar_eliminar)
    ...
    def confirmar_eliminar(self, e):
        ...
        dlg = ft.AlertDialog(
            ...
            actions=[
                ...
                ft.Button("Confirmar y Eliminar", bgcolor=ft.Colors.RED_700, on_click=on_confirm_password),
            ],
        )
