...
def main(page: ft.Page):
    ...
    # Flet moderno (0.85+) usa page.window.width/height.
    # Se mantiene fallback para versiones antiguas.
    try:
    ...
    def actualizar_tamano_overlay(e=None):
        critical_overlay.width = page.width or 1280
        critical_overlay.height = page.height or 800
        page.update()
