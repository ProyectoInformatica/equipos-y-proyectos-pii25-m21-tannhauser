...
def LoginEmpleadoView(page: ft.Page, go):
    auth = AuthController()
    ...
    def intentar_login(e):
        ...
        elif usuario.get("rol") != "empleado":
            mensaje.value = "Este usuario no tiene rol de empleado."
        else:
            mensaje.value = ""
    ...
    card = ft.Container(
        ...
        content=ft.Column(
            [
                ft.Text("Acceso Empleado", size=24, weight=ft.FontWeight.BOLD, color=ft.Colors.GREEN_200),
                ft.Text("Accede a sensores y al inventario.", size=14, color=ft.Colors.GREY_400),
    ...
    fondo = ft.Container(
        ...
        gradient=ft.LinearGradient(
            ...
            colors=[ft.Colors.TEAL_900, ft.Colors.BLACK],
        ),
        content=ft.Column(
            [
                card
