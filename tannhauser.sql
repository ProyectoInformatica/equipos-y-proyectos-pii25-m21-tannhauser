...
(13, 'ordinary_01', 'Sensor ordinario principal', 14, 'Zona general', 'RX/TX', 'activo', '{\"sensor_name\": \"sensor_ordinario\"}', '2026-05-20 00:00:00', 1, NULL, '2026-05-20 00:00:00', '2026-05-20 00:00:00');
...
CREATE TABLE `readings` (
  ...
  `text_value` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `reading_kind` enum('numerico','texto','mixto') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'numerico',
...
(14, 'ORDINARY_SENSOR', 'Sensor ordinario', NULL, 'otro', 'Sensor ordinario que recoge un dato numérico y un dato alfanumérico', '2026-05-20 00:00:00');
